...
while true; do
    ...
    case $ans in
        1 ) ./rabin ./Scripts/beeOnlyScript bee;;
        2 ) ./rabin ./Scripts/abScript ab;;
        3 ) ./rabin ./Scripts/BeeMovieScript bee;;
        ...
        6 ) ./rabin ./Scripts/multipleOccuranceCharacter aab;;
        7 ) exit;;
